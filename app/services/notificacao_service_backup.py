...
class NotificacaoService:
    ...
    def criar_para_ordem(
        ...
        notificacao_existente = (
            NotificacaoRepository.buscar_por_ordem(
                ordem.id
            )
        )
        ...
        return NotificacaoRepository.adicionar(
            notificacao
        )
    ...
    def enviar_notificacao(
        ...
        mensagem = (
            ...
            or NotificacaoService.montar_mensagem(
                ordem
            )
        )

        notificacao.tentativas = (
            (notificacao.tentativas or 0) + 1
        )
